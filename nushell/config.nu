...
$env.config = {
  ...
  completions: {
    ...
    external: {
      ...
      completer: {|span| carapace_by_fzf $span} # check 'carapace_completer' above as an example
    }
  ...
  menus: [
    ...
    }
    {
      ...
      type: {
        ...
        description_offset: 1 # If true, the cursor pos will be corrected, so the suggestions match up with the typed text
        #
        # C:\> str
        #      str join
        #      str trim
  ...
  keybindings: [
    ...
    # using the internal clipboard.
    {
      ...
      keycode: char_c
      mode: emacs
      event: { edit: copyselection } # event: { edit: copyselectionsystem }
    }
    {
      name: cut_selection
      modifier: control_shift
      keycode: char_x
      mode: emacs
      event: { edit: cutselection } # event: { edit: cutselectionsystem }
    } # {
    #     name: paste_system
    #     modifier: control_shift
    #     keycode: char_v
