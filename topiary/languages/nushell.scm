...
(list_body
  entry: (_) @prepend_space @append_space @prepend_spaced_softline
)

(val_list
  item: (_) @prepend_space @append_space @prepend_spaced_softline
)

(record_body
  entry: (record_entry) @prepend_space @append_space @prepend_spaced_softline
)
